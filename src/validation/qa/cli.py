...
from src.validation.qa.validator import run_all, validate_partition
...
def build_parser() -> argparse.ArgumentParser:
    ...
    partition_parser.add_argument("--raw-root", default="artifacts/raw")
    partition_parser.add_argument("--report-root", default="artifacts/qa/reports")

    run_all_parser = subparsers.add_parser("run-all", help="Scan and validate all raw data partitions.")
    run_all_parser.add_argument("--root", default="artifacts/raw")
