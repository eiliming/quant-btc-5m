...
from src.transformation.research_dataset.schema import metadata_path
...
def build_parser() -> argparse.ArgumentParser:
    ...
    build.add_argument("--raw-root", default="artifacts/raw")
    build.add_argument("--qa-report-root", default="artifacts/qa/reports")
    build.add_argument("--output-root", default="artifacts/research/datasets")
    ...
    inspect.add_argument("--root", default="artifacts/research/datasets")
