...
def dataset_path(root: Path, exchange: str, symbol: str, timeframe: str) -> Path:
    return root / exchange / symbol / timeframe / "dataset.parquet"


def metadata_path(root: Path, exchange: str, symbol: str, timeframe: str) -> Path:
    return root / exchange / symbol / timeframe / "metadata.json"
